                    ...
                    <div key={index} className="flex justify-start pt-10 md:pt-40 md:gap-10">
                        <div
                            ...
                            <div>
                                ...
                                <h6 className="hidden md:block text-xl md:pl-20 md:text-l text-neutral-500 dark:text-neutral-500 ">
                        ...
                        <div className="relative pl-20 pr-4 md:pl-4 w-full">
                            <div>
                                ...
                                <h6 className="md:hidden block text-l mb-4 text-left font-bold text-neutral-500 dark:text-neutral-500">
                                    {item.subtitle} <br /> {item.duration}
                                </h6>
                            </div>
                            {item.content}{" "}
